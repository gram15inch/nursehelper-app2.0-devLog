package com.nuhlp.nursehelper.datasource.network

import com.nuhlp.nursehelper.datasource.network.model.NullToEmptyStringAdapter
import com.nuhlp.nursehelper.datasource.network.model.address.AddressResponse
import com.nuhlp.nursehelper.datasource.network.model.place.PlaceResponse
...
fun getAppKakaoApi(): MapsApiService {
    synchronized(MapsApiService::class.java) {
        if (!::INSTANCE.isInitialized) {
            INSTANCE = retrofit.create(MapsApiService::class.java)
        }
